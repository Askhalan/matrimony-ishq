...
class MatchMaritalStatusUC implements UseCase<List<UserEntity>, EmptyParams> {
  final MatchRepository matchRepository;

  MatchMaritalStatusUC({required this.matchRepository});
  @override
  Future<Either<Failure, List<UserEntity>>> call(parameters) async {
    return await matchRepository.fetchMritalStatusMatchUsers();
  }
}
